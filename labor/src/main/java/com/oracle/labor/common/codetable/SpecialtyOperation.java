...
//·-------------------------------------------------------------------------·//	
	...
	public static String getSelectedGz(String selectedId,String gz){
		...
		if("gw".equals(gz)){
			...
			if(selectedId.substring(0, 1).equals("1")) {
				selectedId=selectedId.substring(0, 2)+"50000";
			}else if(selectedId.substring(0, 1).equals("6")) {
				selectedId=selectedId.substring(0, 2)+"40000";
			}else {
				selectedId=selectedId.substring(0, 2)+"10000";	
			}
