...
<body>
	...
	<br/>
	<div align="center">总页数:${pageInfo.pages },总记录数${pageInfo.total},当前页号${pageInfo.pageNum }</div>
	...
	<input type="button" value="添加 新图书" onclick="javascript:location.href='book.jsp'"/>
</body>
</html>