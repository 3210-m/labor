...
<script type="text/javascript">
	$(function(){
		$("#bioName").click(function(){
			var url =  $("#pageContext").val()+"/service/selectBioNameByNo/";
			$("#bioNo").load(url,{bioNo:$("#bioNo").val()},function(data){
...
<body>
	<form method="post" name="form1" action="dwdj_dj_2.jsp">
	<input type = "hidden" value = "${pageContext.request.contextPath}" id ="pageContext">
		<table width="98%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td height="20" valign="bottom"><img
					...
					width="11" height="12"> 当前位置：职业介绍 &gt; 单位招聘 &gt; 冻结/解冻</td>
			</tr>
			<tr>
				<td valign="bottom"
				...
				<TD align="center" class="line2">
					<table width="297" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="160"><input id="bioNo" name="bioNo" type="text"
								maxlength="64" style='width: 100%' onblur="huitian2()"></td>
				...
				<TD align="center" class="line1">
					<table width="297" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="23" align="right"></td>
							<td width="160"><input id="bioName" name="bioName"
								type="text" maxlength="64" style='width: 100%'></td>
							<td width="24" align="right"></td>
						</tr>
		...
		<table width="98%" border="0" align="center">
			<TR align="center" class="line2">
				<TD><INPUT name="button1" type="button" id = "button1" class="BUTTONs3"
					value="确 定"> &nbsp;&nbsp;<INPUT
