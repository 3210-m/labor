...
<body>
<form name="form1" action="dwdj_dj_3.jsp" method="post">
...
<tr>
  <td valign="top">	
    <table width="100%" align="center" border="0" cellpadding="1" cellspacing="1" >
      ...
      <tr align="center"  >
		<td class="line4">1${DwInfo.s}</td>
        <td class="line4">1${DwInfo.bio_name}</td>
        <td class="line4">1${DwInfo.bio_bua_address}</td>
        <td class="line4">1${DwInfo.lxrsj}</td>
        <td class="line4">1${DwInfo.djsj}</td>
</tr>     
    </table> </td>
</tr>
</table>
