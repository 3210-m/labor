...
<script type="text/javascript">
	$(function(){
		//大类
		$("#gw").load("gz/gw/1000000")
		//中类
		$("#gz1").load("gz/gz1/1000000");
		//小类
		$("#gz2").load("gz/gz2/1050000");
		//细类
		//$("#gz3").load("gz/gz3/1050100");		//细类初始化为空
		...
		$("#gw").change(function(){
			...
			$("#gz2").empty();
			$("#gz3").empty();
			var g1 = "gz/gz1/"+$("#gw").val();
			$.get(g1,function(data){
				$("#gz1").html(data);
				var g2 = "gz/gz2/"+$("#gz1").val();
				$.get(g2,function(data){
					$("#gz2").html(data);
					var g3 = "gz/gz3/"+$("#gz2").val();
					$.get(g3,function(data){
						$("#gz3").html(data);
					});
				});
			});
		...
		$("#gz2").change(function(){
			...
			$.get(g3,function(data){
				...
				$("#gzdm").val($("#gz3").val());
				//获得gzmc
				$("#gzmc").load("gzmc/",{gzdm:$("#gzdm").val()},function(data){
					$("#gzmc").val(data);
				});
			});
		});
